...
if (!function_exists('sample_theme_setup')) :
	...
	function sample_theme_setup()
	{
		...
		// Add support for default/core block style
		...
		// disabling custom colors option in the block editor
		add_theme_support('disable-custom-colors');

		// Add suport for font sizes
		...
		// disabling support for custom font sizes
...
function sample_theme_scripts()
{
	...
	// fundation style
	wp_enqueue_style('sample-theme-foundation',get_template_directory_uri() . '/assets/css/vendors/foundation.min.css', null, '6.5.1');

	// adding what-input js
	wp_enqueue_script( 'sample-theme-what-input', get_template_directory_uri() . '/assets/js/vendors/what-input.js', array('jquery'), '6.5.1', true );

	// adding sample theme foundation js
	wp_enqueue_script( 'sample-theme-foundation', get_template_directory_uri() . '/assets/js/vendors/foundation.min.js', array('jquery', 'sample-theme-what-input'), '6.5.1', true );
